...
interface OtherDocumentDisplayProps {
  data: Record<string, any>;
}

export const OtherDocumentDisplay = ({ data }: OtherDocumentDisplayProps) => {
      ...
      <div className="flex items-center justify-between mb-2">
        <div>
          <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            Other Document Display
          </h3>
          <p className="text-sm text-gray-600 mt-1">Other document types</p>
        </div>
        <Badge variant="secondary" className="bg-green-100 text-green-800 h-fit">Processed</Badge>
      </div>
      <Card>
        <CardHeader>
          <CardTitle className="text-sm">Other Document Information</CardTitle>
        </CardHeader>
